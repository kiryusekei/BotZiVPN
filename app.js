...
const statusReseller = isReseller ? 'Reseller' : 'Bukan Reseller';
  ...
  const messageText = `
<b>╭━━━〔 ⚡ ZIVPN UDP • ${NAMA_STORE} 〕━━━╮</b>

<b>👋 Selamat datang, <code>${userName}</code>!</b>
...
<b>╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯</b>
<i>⚡ Fast • Secure • Reliable VPN Service</i>
`;
  ...
  try {
    ...
    for (const [uniqueCode, deposit] of pendingDeposits) {
      ...
      try {
        ...
        const checkPaymentUrl = `https://mutasiv1.autsc.my.id/check-payment?auth=${APIKEY}&merchant=${AUTH_USER}&token=${AUTH_TOKEN}`;
